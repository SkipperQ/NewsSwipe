package com.newsswipe.repository;
...
import com.newsswipe.NewsSwipeApplication;
import com.newsswipe.database.NewsSwipeDatabase;
import com.newsswipe.model.Article;
import com.newsswipe.model.NewsResponse;
import com.newsswipe.network.NewsApi;
import com.newsswipe.network.RetrofitClient;
...
public class NewsRepository {
    ...
    private final NewsSwipeDatabase database;

    public NewsRepository() {
        newsApi = RetrofitClient.newInstance().create(NewsApi.class);
        database = NewsSwipeApplication.getDatabase();
    }
    ...
    private static class FavoriteAsyncTask extends AsyncTask<Article, Void, Boolean> {
        ...
        private FavoriteAsyncTask(NewsSwipeDatabase database, MutableLiveData<Boolean> liveData) {
